...
if (isset($_GET['id'])) {
    ...
    $searchCategories = "SELECT wpisy.id, wpisy.tytul, uzytkownicy.nazwa, wpisy.data_publikacji, wpisy.zawartosc, kategorie.kategoria FROM wpisy LEFT JOIN uzytkownicy ON wpisy.uzytkownik_id=uzytkownicy.id LEFT JOIN kategorie ON wpisy.id=kategorie.wpis_id WHERE kategorie.kategoria= '$id';";
    $resultCategories = $connect->query($searchCategories);
    while ($rowPosts = $resultCategories->fetch_assoc()) {
        echo '<div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="https://dummyimage.com/850x350/dee2e6/6c757d.jpg"
                                alt="..." /></a>
                            <div class="card-body">
                            <div class="small text-muted">Post znaleziony po kategori</div>
